               ...
               <div class="main-type-description">
                ...
                <div class="sub-content-description">
                    ...
                    <div class="footer-section-description">
                        ...
                        <a class="btn-order btn-link hidden-xs">Оставить завяку на заказ</a>
                    </div>
                <!-- // Footer Section -->
                ...
                <section class="modal-block col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    ...
                    <h4 class="header-modal">Оставьте ваши данные и мы свяжемся позднее</h4>
                    <form id="form-reset-login" class="login-form" action="/echo" method="post">
                        ...
                        <section class="modal-block-error-email">
                            <p>Извините, но ваш E-mail слишком короткий</p>
                            <a class="btn close-modal-btn-email" href="#">выйти</a>
                        </section>
                    </form>
                </section>
                <!-- //Modal -->
